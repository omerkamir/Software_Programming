...
def function2():
	...
	x = np.arange(11,37,dtype=np.float64).reshape((3,3,3))	 #wrtie your code here
...
def function14():
	...
	# Hint use split method
 	...
 	arr = np.arange(10, 34, 1).reshape(6,4) #write reshape code
	ans = np.array_split(arr,10) 
  return ans
	"""
	Expected Output:
...
def function18():
	...
	x = np.count_nonzero(students < np.argmax(piaic))	   # Write you code Here
	return x
	#Expected output: 3
